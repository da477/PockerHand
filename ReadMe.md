...
Your need to implement the `process` method in the [Solver.java](src/main/java/com/evolution/bootcamp/assignment/poker/Solver.java)
class.

All the unit tests in [TexasHoldemSolverTest.java](src/test/java/com/evolution/bootcamp/assignment/poker/TexasHoldemSolverTest.java),
[OmahaHoldemSolverTest.java](src/test/java/com/evolution/bootcamp/assignment/poker/OmahaHoldemSolverTest.java),
and [FiveCardDrawSolverTest.java](src/test/java/com/evolution/bootcamp/assignment/poker/FiveCardDrawSolverTest.java) should pass.
There will also be other tests run after you submit your solver.
